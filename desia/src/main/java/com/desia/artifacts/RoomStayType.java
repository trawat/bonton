...
@XmlSeeAlso({
    com.desia.artifacts.OTAHotelAvailRS.RoomStays.RoomStay.class,
    com.desia.artifacts.RoomStaysType.RoomStay.class,
    com.desia.artifacts.HotelRoomListType.RoomStays.RoomStay.class
})
