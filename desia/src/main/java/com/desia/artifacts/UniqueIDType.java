...
@XmlSeeAlso({
    com.desia.artifacts.OTAHotelAvailRS.RoomStays.RoomStay.Reference.class,
    com.desia.artifacts.OTACancelRQ.UniqueID.class,
    com.desia.artifacts.RoomStaysType.RoomStay.Reference.class,
    com.desia.artifacts.ProfileType.UserID.class,
    com.desia.artifacts.SourceType.RequestorID.class
})
