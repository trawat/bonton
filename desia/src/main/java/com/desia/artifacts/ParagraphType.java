...
@XmlSeeAlso({
    com.desia.artifacts.ProfileType.Comments.Comment.class,
    DescriptionType.class,
    com.desia.artifacts.SpecialRequestType.SpecialRequest.class,
    com.desia.artifacts.CommentType.Comment.class,
    com.desia.artifacts.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.desia.artifacts.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    com.desia.artifacts.InvBlockType.BlockDescriptions.BlockDescription.class
})
