...
@XmlSeeAlso({
    ...
    com.desia.artifacts.DirectBillType.CompanyName.class,
    TravelArrangerType.class,
    com.desia.artifacts.ContactInfoType.CompanyName.class,
    com.desia.artifacts.AllianceConsortiumType.AllianceMember.class
})
