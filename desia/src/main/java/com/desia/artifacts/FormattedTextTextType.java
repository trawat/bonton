...
@XmlSeeAlso({
    com.desia.artifacts.ImageDescriptionType.Description.class,
    com.desia.artifacts.RateQualifierType.RateComments.RateComment.class,
    com.desia.artifacts.TextDescriptionType.Description.class,
    com.desia.artifacts.ParagraphType.ListItem.class
})
