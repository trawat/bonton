...
@XmlSeeAlso({
    com.desia.artifacts.HotelInfoType.Descriptions.MultimediaDescriptions.class,
    com.desia.artifacts.AreaInfoType.Recreations.Recreation.MultimediaDescriptions.class,
    com.desia.artifacts.RestaurantType.MultimediaDescriptions.class
})
