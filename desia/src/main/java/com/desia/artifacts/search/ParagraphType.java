...
@XmlSeeAlso({
    com.desia.artifacts.search.ProfileType.Comments.Comment.class,
    DescriptionType.class,
    com.desia.artifacts.search.SpecialRequestType.SpecialRequest.class,
    com.desia.artifacts.search.CommentType.Comment.class,
    com.desia.artifacts.search.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class,
    com.desia.artifacts.search.AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class,
    com.desia.artifacts.search.InvBlockType.BlockDescriptions.BlockDescription.class
})
