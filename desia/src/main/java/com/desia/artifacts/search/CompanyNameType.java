...
@XmlSeeAlso({
    ...
    com.desia.artifacts.search.DirectBillType.CompanyName.class,
    TravelArrangerType.class,
    com.desia.artifacts.search.ContactInfoType.CompanyName.class,
    com.desia.artifacts.search.AllianceConsortiumType.AllianceMember.class
})
