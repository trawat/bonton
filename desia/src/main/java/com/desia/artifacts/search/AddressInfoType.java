...
@XmlSeeAlso({
    com.desia.artifacts.search.CompanyInfoType.AddressInfo.class,
    com.desia.artifacts.search.CustomerType.Address.class,
    com.desia.artifacts.search.AddressesType.Address.class,
    com.desia.artifacts.search.RequiredPaymentsType.GuaranteePayment.Address.class
})
