...
@XmlSeeAlso({
    com.desia.artifacts.search.ImageDescriptionType.Description.class,
    com.desia.artifacts.search.RateQualifierType.RateComments.RateComment.class,
    com.desia.artifacts.search.TextDescriptionType.Description.class,
    com.desia.artifacts.search.ParagraphType.ListItem.class
})
