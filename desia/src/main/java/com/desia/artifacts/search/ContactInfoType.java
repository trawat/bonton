...
@XmlSeeAlso({
    com.desia.artifacts.search.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class,
    ContactInfoRootType.class,
    com.desia.artifacts.search.AreaInfoType.Attractions.Attraction.Contact.class
})
