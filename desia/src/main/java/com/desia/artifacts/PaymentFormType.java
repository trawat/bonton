...
@XmlSeeAlso({
    com.desia.artifacts.CompanyInfoType.PaymentForm.class,
    HotelPaymentFormType.class,
    com.desia.artifacts.CustomerType.PaymentForm.class,
    PaymentDetailType.class,
    com.desia.artifacts.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class
})
