...
@XmlSeeAlso({
    com.desia.artifacts.OTACancelRQ.OriginAndDestinationSegment.Traveler.class,
    com.desia.artifacts.DonationType.DonorInfo.Name.class,
    com.desia.artifacts.VerificationType.PersonName.class,
    com.desia.artifacts.TravelClubType.ClubMemberName.class,
    com.desia.artifacts.ContactsType.Name.class,
    com.desia.artifacts.OrganizationType.OrgMemberName.class
})
