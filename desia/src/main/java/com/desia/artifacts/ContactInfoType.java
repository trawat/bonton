...
@XmlSeeAlso({
    com.desia.artifacts.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class,
    ContactInfoRootType.class,
    com.desia.artifacts.AreaInfoType.Attractions.Attraction.Contact.class
})
