...
@XmlSeeAlso({
    com.desia.artifacts.booking.CompanyInfoType.PaymentForm.class,
    HotelPaymentFormType.class,
    com.desia.artifacts.booking.CustomerType.PaymentForm.class,
    PaymentDetailType.class,
    com.desia.artifacts.booking.GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class
})
