...
@XmlSeeAlso({
    com.desia.artifacts.booking.OTAHotelAvailRS.RoomStays.RoomStay.class,
    com.desia.artifacts.booking.RoomStaysType.RoomStay.class,
    com.desia.artifacts.booking.HotelRoomListType.RoomStays.RoomStay.class
})
