...
@XmlSeeAlso({
    com.desia.artifacts.booking.HotelInfoType.OwnershipManagementInfos.OwnershipManagementInfo.class,
    ContactInfoRootType.class,
    com.desia.artifacts.booking.AreaInfoType.Attractions.Attraction.Contact.class
})
