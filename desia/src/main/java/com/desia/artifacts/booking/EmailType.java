...
@XmlSeeAlso({
    com.desia.artifacts.booking.EmailsType.Email.class,
    com.desia.artifacts.booking.CompanyInfoType.Email.class,
    com.desia.artifacts.booking.CustomerType.Email.class
})
