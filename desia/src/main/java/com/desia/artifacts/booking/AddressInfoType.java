...
@XmlSeeAlso({
    com.desia.artifacts.booking.CompanyInfoType.AddressInfo.class,
    com.desia.artifacts.booking.CustomerType.Address.class,
    com.desia.artifacts.booking.AddressesType.Address.class,
    com.desia.artifacts.booking.RequiredPaymentsType.GuaranteePayment.Address.class
})
