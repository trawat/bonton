...
@XmlSeeAlso({
    com.desia.artifacts.booking.HotelRoomListType.Guests.Guest.class,
    com.desia.artifacts.booking.HotelRoomListType.MasterContact.class,
    com.desia.artifacts.booking.RecipientInfosType.RecipientInfo.class
})
