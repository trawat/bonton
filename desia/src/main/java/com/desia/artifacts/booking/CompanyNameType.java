...
@XmlSeeAlso({
    ...
    com.desia.artifacts.booking.DirectBillType.CompanyName.class,
    TravelArrangerType.class,
    com.desia.artifacts.booking.ContactInfoType.CompanyName.class,
    com.desia.artifacts.booking.AllianceConsortiumType.AllianceMember.class
})
