...
@XmlSeeAlso({
    com.desia.artifacts.booking.ImageDescriptionType.Description.class,
    com.desia.artifacts.booking.RateQualifierType.RateComments.RateComment.class,
    com.desia.artifacts.booking.TextDescriptionType.Description.class,
    com.desia.artifacts.booking.ParagraphType.ListItem.class
})
