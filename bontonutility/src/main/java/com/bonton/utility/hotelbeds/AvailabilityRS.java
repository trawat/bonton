...
// Generated on: 2016.06.28 at 05:21:02 PM IST 
//
...
public class AvailabilityRS {
    ...
    public static class Hotels {
        ...
        protected List<AvailabilityRS.Hotels.Hotel> hotel;
         ...
         * 
         */
        public List<AvailabilityRS.Hotels.Hotel> getHotel() {
            if (hotel == null) {
                hotel = new ArrayList<AvailabilityRS.Hotels.Hotel>();
            }
            return this.hotel;
        }
        ...
        public static class Hotel {
            ...
            public static class Rooms {
                ...
                protected List<AvailabilityRS.Hotels.Hotel.Rooms.Room> room;
                 ...
                 * 
                 */
                public List<AvailabilityRS.Hotels.Hotel.Rooms.Room> getRoom() {
                    if (room == null) {
                        room = new ArrayList<AvailabilityRS.Hotels.Hotel.Rooms.Room>();
                    }
                    return this.room;
                }
                ...
                public static class Room {
                    ...
                    public static class Rates {
                        ...
                        public static class Rate {
                            ...
                            @XmlElement(required = true)
                            protected AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates dailyRates;
                             ...
                             * @return
                             *     possible object is
                             *     {@link AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates }
                             *     
                             */
                            public AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates getDailyRates() {
                                return dailyRates;
                            }
                             ...
                             *     
                             */
                            public void setDailyRates(AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates value) {
                            ...
                            public static class CancellationPolicies {
                                ...
                                @XmlElement(required = true)
                                protected List<AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.CancellationPolicies.CancellationPolicy> cancellationPolicy;
                                 ...
                                 * 
                                 */
                                public List<AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.CancellationPolicies.CancellationPolicy> getCancellationPolicy() {
                                    if (cancellationPolicy == null) {
                                        cancellationPolicy = new ArrayList<AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.CancellationPolicies.CancellationPolicy>();
                                    }
                            ...
                            public static class DailyRates {
                                ...
                                @XmlElement(required = true)
                                protected List<AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates.DailyRate> dailyRate;
                                 ...
                                 * <p>
                                 * Objects of the following type(s) are allowed in the list
                                 * {@link AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates.DailyRate }
                                 * 
                                 * 
                                 */
                                public List<AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates.DailyRate> getDailyRate() {
                                    if (dailyRate == null) {
                                        dailyRate = new ArrayList<AvailabilityRS.Hotels.Hotel.Rooms.Room.Rates.Rate.DailyRates.DailyRate>();
                                    }
